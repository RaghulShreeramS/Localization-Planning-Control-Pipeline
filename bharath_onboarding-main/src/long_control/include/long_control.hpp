...
class LongControl : public rclcpp::Node
{
  public:
    ...
    std_msgs::msg::Empty heartbeatMsg;
  ...
  private:
    ...
    rclcpp::Subscription<autonoma_msgs::msg::PowertrainData>::SharedPtr subPtReport_;
    ...
    // history for longitudinal error safety checks
    int long_err_history_counter = 0;
    std::vector<double> long_err_history;
    std::vector<rclcpp::Time> long_err_time_history; 
